    ...
    try:
        ...
        if resume_from:
            ...
            if phase == 2:
                ...
                pretrained_weights_path = r"e:\KingCrimson Dataset\Simulate\data0\results49\phase_1\model_cn_best"
                if os.path.exists(pretrained_weights_path):
                    try:
                        ...
                        print(f"加载预训练权重失败: {e}")
                pretrained_weights_path_bqd = r"e:\KingCrimson Dataset\Simulate\data0\results49\bqd\model_bqd_best"
                ...
                # Load pre-trained weights if available
                pretrained_weights_path_cn = r"e:\KingCrimson Dataset\Simulate\data0\results49\phase_3\model_cn_step7500"
                ...
                pretrained_weights_path_cd = r"e:\KingCrimson Dataset\Simulate\data0\results49\phase_3\model_cd_step7500"
        ...
        if step_phase1 < steps_1 and phase == 1:
            ...
            try:
                ...
                """model_cn.load_state_dict(
                            torch.load(
                                r"e:\KingCrimson Dataset\Simulate\data0\results49\phase_1\model_cn_step22500",
                                map_location=device,
                                weights_only=True,
                            )
                        )
                model_bqd.load_state_dict(
                            torch.load(
                                r"e:\KingCrimson Dataset\Simulate\data0\results49\bqd\model_bqd_step22500",
                                map_location=device,
                                weights_only=True,
                            )
                        )"""
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dir", type=str, default="results49", help="directory to save results"
    )
    parser.add_argument(
        "--envi", type=str, default="DEM49", help="visdom environment name"
    )
