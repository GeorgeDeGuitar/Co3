...
def train(dir, envi, cuda, batch, test=False, resume_from=None, Phase=1):
    try:
        ...
        mask_cache_dir = "./mask_cache_129"  # mask缓存目录
        ...
        if resume_from:
            ...
            if phase == 2:
                ...
                pretrained_weights_path = r"e:\KingCrimson Dataset\Simulate\data0\results45\phase_1\model_cn_step100000"
                if os.path.exists(pretrained_weights_path):
                    try:
                ...
                pretrained_weights_path_bqd = r"e:\KingCrimson Dataset\Simulate\data0\results45\bqd\model_bqd_best"
                ...
                # Load pre-trained weights if available
                pretrained_weights_path_cn = r"e:\KingCrimson Dataset\Simulate\data0\results47\phase_1\model_cn_step50000"
                ...
                pretrained_weights_path_cd = r"e:\KingCrimson Dataset\Simulate\data0\results47\phase_2\model_cd_step50000"
                ...
                pretrained_weights_path_bqd = r"e:\KingCrimson Dataset\Simulate\data0\results47\bqd\model_bqd_best"
                if os.path.exists(pretrained_weights_path_bqd):
                    try:
                        model_bqd.load_state_dict(
                            torch.load(
...
"""
        ...
        if step_phase3 < steps_3 and phase == 3:
            ...
            try:
                ...
                '''model_cd.load_state_dict(
                            torch.load(
                                r"e:\KingCrimson Dataset\Simulate\data0\results45\phase_2\model_cd_step80000",
                                map_location=device,
                                weights_only=True,
                            )
                        )
                model_bqd.load_state_dict(
                            torch.load(
                                r"e:\KingCrimson Dataset\Simulate\data0\results45\bqd\model_bqd_best",
                                map_location=device,
                                weights_only=True,
                            )
                        )'''
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dir", type=str, default="results47", help="directory to save results"
    )
    parser.add_argument(
        "--envi", type=str, default="DEM47", help="visdom environment name"
    )
