...
def train(resume_from=None):
    ...
    steps_3 = 60000  # 400000  # Phase 3 training steps
    ...
    snaperiod_3 = 2000   # 10000  # How often to save snapshots in phase 3
